...
DEBUG = os.environ.get('DEBUG', True) # !IMPORTANT: set false on heroku

HOST = os.environ.get('IP', '127.0.0.1') # set to 0.0.0.0 on heroku
PORT = os.environ.get('PORT', 5000) # set automatically by heroku
